class Report < ApplicationRecord
  belongs_to :user
  scope :select_report, -> {select("reports.*, users.name as name, users.avatar as avatar, users.is_blocked as is_blocked, users.id as user_id")}
